...
| [Benimsenme / Kullanım Oranı](terms/tr/b/adoption-rate.md) | Adoption Rate | `success-criteria` |
...
| Terim (TR) | İngilizce Karşılık | Alan (Domain) |
| :--- | :--- | :--- |
| [Hata Bütçesi](terms/tr/h/error-budget.md) | Error Budget | `success-criteria` |
...
| [Hedefler ve Temel Sonuçlar](terms/tr/h/okr.md) | Objectives and Key Results (OKR) | `success-criteria` |
| [Hedef Değer](terms/tr/h/target-value.md) | Target Value | `success-criteria` |
| [Hizmet Seviyesi Göstergeleri ve Hedefleri](terms/tr/h/sli-slo-sla.md) | SLI / SLO / SLA | `success-criteria` |
...
| [İş Paketi](terms/tr/i/work-package.md) | Work Package | `scope-definition` |

### K

| Terim (TR) | İngilizce Karşılık | Alan (Domain) |
| :--- | :--- | :--- |
| [Kapsamı Koruma ve Dondurma](terms/tr/k/scope-shielding-scope-freeze.md) | Scope Shielding / Scope Freeze | `scope-definition` |
| [Kapsam Belirsizliği](terms/tr/k/scope-ambiguity.md) | Scope Ambiguity | `scope-definition` |
| [Kapsam Boşluğu](terms/tr/k/gap-in-scope.md) | Gap in Scope | `scope-definition` |
| [Kapsam Doğrulama ve Geçerleme](terms/tr/k/scope-verification-vs-validation.md) | Scope Verification vs. Scope Validation | `scope-definition` |
| [Kapsam İçi ve Kapsam Dışı](terms/tr/k/in-scope-vs-out-of-scope.md) | In-Scope vs. Out-of-Scope | `scope-definition` |
...
| [Kritik Başarı Faktörü](terms/tr/k/csf.md) | Critical Success Factor (CSF) | `success-criteria` |
| [Kullanıcı Benimsemesi ve Etkileşimi](terms/tr/k/user-adoption-engagement.md) | User Adoption & Engagement | `business-value` |
| [Kullanıcı Tutma Oranı](terms/tr/k/retention-rate.md) | Retention Rate | `success-criteria` |
| [Kurumsal Hazırlık](terms/tr/k/organizational-readiness.md) | Organizational Readiness | `feasibility-analysis` |
| [Kuzey Yıldızı Metriği](terms/tr/k/north-star-metric.md) | North Star Metric (NSM) | `success-criteria` |
...
| Terim (TR) | İngilizce Karşılık | Alan (Domain) |
| :--- | :--- | :--- |
| [Taban Çizgisi / Başlangıç Değeri](terms/tr/t/baseline.md) | Baseline | `success-criteria` |
...
| [Toplam Sahip Olma Maliyeti](terms/tr/t/tco.md) | Total Cost of Ownership (TCO) | `feasibility-analysis` |

### Y

| Terim (TR) | İngilizce Karşılık | Alan (Domain) |
| :--- | :--- | :--- |
| [Yanıt Süresi Hedefleri](terms/tr/y/latency-response-time.md) | Latency / Response Time (p95 / p99) | `success-criteria` |
...
| Terim (TR) | İngilizce Karşılık | Alan (Domain) |
| :--- | :--- | :--- |
| [Zamanında ve Bütçe Dahilinde Teslimat](terms/tr/z/on-time-on-budget-delivery.md) | On-Time & On-Budget Delivery | `success-criteria` |
